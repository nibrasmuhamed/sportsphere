...
//
//	mockgen -source=db/unit_of_work.go -destination=./mocks/mock_uow.go -package=mocks
//
...
func (mr *MockUnitOfWorkMockRecorder) QueueCreate(container, object any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUnitOfWorkMockRecorder) QueueCreateMany(container, object any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUnitOfWorkMockRecorder) QueueDelete(container, keyName, keyValue, operatorId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUnitOfWorkMockRecorder) QueueUpdate(container, keyName, keyValue, object, operatorId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
