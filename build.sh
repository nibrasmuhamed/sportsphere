...
Version="github.com/nibrasmuhamed/sportsphere/internal/meta.Version=${version}"
BuildTime="github.com/nibrasmuhamed/sportsphere/internal/meta.BuildTime=${buildTime}"
CommitID="github.com/nibrasmuhamed/sportsphere/internal/meta.CommitID=${cId}"
